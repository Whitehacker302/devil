...
logo = """  ▄︻┻═┳一 ЩєLc๏Mє ┼๏ ┼ђє Fąş┼єş┼ єVєr cL๏ЙIЙG
           ▄︻┻═┳一 ♥WhͪiͥᴛⷮeͤDͩeͤvͮiͥl-๏FFIcIąL♥️----------🔴
           ▄︻┻═┳一 ♥️♥️ W̴͇̪̫̽̈́̚h̵̘̼͋̽̓i̸͔̝͛͋͌t̵͙̞̦͋͆͠ë̸̡̡̺́́͌D̴̡̪͔̈́͘̕e̵̡̞͚͛̐̕v̴͓̠̞͐̾ḯ̸̼͙͙͝͠ĺ̸͇̠̙̽̾ - cL๏Йєr  ♥️♥️----🔴🔴
           ▄︻┻═┳一    💪💪Devil-Boy💪💪   🔴🔴
           ▄︻┻═┳一 ---- FєєL ┼ђє P๏Щєr WₕᵢₜₑDₑᵥᵢₗ--------🔴🔴
...
╋┗┛┗┛┗┛┗┻┻━┻━━┻━━━┻━━┛┗┛┗┻━┛
               ...
               WhatsApp: Čoming soon
                        W̷h̷i̷t̷e̷D̷e̷v̷i̷l̷
                     ▇◤▔▔▔▔▔▔▔◥▇
                     ▇▏◥▇◣┊◢▇◤▕▇
                     ▇▏▃▆▅▎▅▆▃▕▇
                     ▇▏╱▔▕▎▔▔╲▕▇
...
\033[1;91m=======================================
\033[1;96mAuthor  \033[1;93m: \033[1;92mWₕᵢₜₑDₑᵥᵢₗ
\033[1;96mInstagram \033[1;93m: \033[1: WₕᵢₜₑDₑᵥᵢₗ
\033[1;96mFacebook  \033[1;93m: \033[1: WₕᵢₜₑDₑᵥᵢₗ
\033[1;96mGithub \033[1;93m: \033[1;92mhttps://github.com/Whitehacker302/devil
\033[1;91m======================================="""
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            os.system('xdg-open https://youtu.be/Rup4VcRcdQQ ')
    else:
...
def login():
	...
	try:
		...
		if 'checkpoint' in url:
			print("\n\033[1;96m[!] \x1b[1;91m New account banwo old  checkpoint par ha")
...
def menu():
	...
	try:
		...
		os.system('clear')
		print"\033[1;96m[!] \033[1;91mNew account banwo old  checkpoint par ha "
		os.system('rm -rf login.txt')
		time.sleep(1)
		login()
	except requests.exceptions.ConnectionError:
...
def pilih_super():
	...
	p.map(main, id)
	print 42*"\033[1;96m="
	print '\033[1;96m[\033[1;97m✓\033[1;96m] \033[1;92mProcess Has Been Completed WₕᵢₜₑDₑᵥᵢₗ says Thank You♥️ \033[1;97m....'
